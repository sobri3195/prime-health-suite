          ...
          {(q.data?.artikel ?? []).map((a) => (
            <Link key={a.id} to="/apps/edukasi/$slug" params={{ slug: a.slug }}
              ...
              <div className="flex items-start gap-3">
                <div className="rounded-xl bg-[#fdf2c4] p-2"><BookOpen className="h-5 w-5 text-[#a08a2a]" /></div>
                <div className="flex-1">
                  <div className="text-[10px] uppercase tracking-wider text-[#a08a2a]">{a.kategori}</div>
