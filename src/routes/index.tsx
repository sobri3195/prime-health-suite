...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Prime Health Suite — Sistem Terpadu Klinik Mata" },
      { name: "twitter:description", content: "Portal pasien, SIM klinik, dan finance dalam satu suite terpadu untuk klinik mata modern." },
      { name: "robots", content: "index,follow,max-image-preview:large" },
      { name: "theme-color", content: "#0c2340" },
      { name: "author", content: "Prime Health Suite" },
    ],
    links: [
      { rel: "canonical", href: `${SITE}/` },
      { rel: "icon", type: "image/svg+xml", href: faviconDataUrl("✦") },
      { rel: "preconnect", href: "https://wzwraemtrotkhujvpgpt.supabase.co" },
    ],
    scripts: [
      {
