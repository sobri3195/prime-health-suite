                  ...
                  <TableCell className="text-right">
                    <Button size="sm" variant="outline" className="h-7 gap-1" onClick={async () => {
                      ...
                      const doc = await generatePayslipPDF({
                        ...
                        potongan_pph: Number(it.potongan_pph21 ?? it.potongan_pph) || 0,
                        potongan_bpjs: (Number(it.potongan_bpjs_kes) || 0) + (Number(it.potongan_bpjs_tk) || 0) + (Number(it.potongan_bpjs) || 0),
