...
const ROW_SCHEMAS: Record<FinTable, z.ZodTypeAny> = {
  ...
  fin_dokter: z.object({ code: nonEmpty, name: nonEmpty, spesialisasi: optStr, default_fee_pct: numNN.max(100).optional(), schedule_note: optStr, is_active: bool, user_id: uuid.nullable().optional() }),
  ...
  fin_tarif_pajak: z.object({ code: nonEmpty, name: nonEmpty, rate: numNN.max(100), coa_hutang: optStr, is_active: bool, note: optStr }),
