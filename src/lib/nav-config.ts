...
export const NAV: Record<System, NavItem[]> = {
  apps: [
    ...
    { slug: "booking", label: "Booking Dokter", icon: Calendar },
  ...
  "sim-klinik": [
    { slug: "", label: "Dashboard Klinik", icon: LayoutDashboard, group: "Dashboard", roles: ["super_admin","admin_klinik","manajemen","dokter","perawat","perawat_optometri","kasir","farmasi","pendaftaran"] },
    { slug: "pasien", label: "Pasien", icon: Stethoscope, group: "Operasional", roles: ["super_admin","admin_klinik","pendaftaran","dokter","perawat","perawat_optometri","kasir","manajemen"] },
    { slug: "registrasi", label: "Registrasi & Kunjungan", icon: UserPlus, group: "Operasional", roles: ["super_admin","admin_klinik","pendaftaran"] },
    { slug: "antrian", label: "Antrian", icon: ListChecks, group: "Operasional", roles: ["super_admin","admin_klinik","pendaftaran","dokter","perawat","perawat_optometri","kasir"] },
    { slug: "jadwal", label: "Jadwal Dokter", icon: Calendar, group: "Operasional", roles: ["super_admin","admin_klinik","pendaftaran","manajemen"] },
    { slug: "pemeriksaan", label: "Pemeriksaan & Rekam Medis", icon: ClipboardList, group: "Operasional", roles: ["super_admin","admin_klinik","dokter","perawat","perawat_optometri"] },
    { slug: "tindakan", label: "Tindakan", icon: Activity, group: "Operasional", roles: ["super_admin","admin_klinik","dokter","perawat","perawat_optometri","kasir","manajemen"] },
    { slug: "resep", label: "Resep & Farmasi", icon: Pill, group: "Operasional", roles: ["super_admin","admin_klinik","dokter","farmasi"] },
    { slug: "billing", label: "Kasir & Billing", icon: Receipt, group: "Operasional", roles: ["super_admin","admin_klinik","kasir","manajemen"] },
    { slug: "dokumen", label: "Dokumen Pasien", icon: Files, group: "Operasional", roles: ["super_admin","admin_klinik","dokter","perawat","perawat_optometri"] },
    { slug: "obat", label: "Stok Obat", icon: Boxes, group: "Master", roles: ["super_admin","admin_klinik","farmasi","manajemen"] },
    { slug: "master", label: "Master Data Klinik", icon: Database, group: "Master", roles: ["super_admin","admin_klinik"] },
    { slug: "users", label: "Manajemen User", icon: Users, group: "Master", roles: ["super_admin","admin_klinik"] },
    { slug: "diklat", label: "Diklat & Dokumentasi", icon: GraduationCap, group: "SDM", roles: ["super_admin","admin_klinik","dokter","perawat","perawat_optometri","manajemen"] },
    { slug: "absensi", label: "Absensi", icon: Clock, group: "SDM" },
    { slug: "lembur", label: "Lembur", icon: Timer, group: "SDM" },
    { slug: "laporan", label: "Laporan Klinik", icon: BarChart3, group: "Laporan", roles: ["super_admin","admin_klinik","manajemen"] },
    { slug: "audit", label: "Audit Log Klinik", icon: ScrollText, group: "Laporan", roles: ["super_admin","admin_klinik","manajemen"] },
    { slug: "settings", label: "Settings", icon: Settings, group: "Sistem", roles: ["super_admin","admin_klinik"] },
  ],
  finance: [
